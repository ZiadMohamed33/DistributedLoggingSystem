...
- Create Angular project with ng: `ng new distributedloggingsystem.client --defaults --skip-install --skip-git `.
...
- Create project file (`distributedloggingsystem.client.esproj`).
